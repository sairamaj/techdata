### KeyEqualityComparer used for Distinct
[source](https://github.com/jehugaleahsa/ComparerExtensions/blob/master/ComparerExtensions/KeyEqualityComparer.cs)
```csharp
...
### Usage
```csharp
    g.Distinct(new KeyEqualityComparer<TrxRecord>(r => r.Name));
```